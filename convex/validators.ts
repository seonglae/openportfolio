// Bridges @openportfolio/domain's plain string vocabularies into Convex
// validators. The vocabularies stay dependency-free so plain node and the
// browser can import them; only this file, inside convex/, knows about `v`.
